...
// // Inject topic in confirmation popup after removing any previous injected
// topics
...
// listitem.remove();
// // ...the list will be refreshed and the temporary class for border styling
// removed
// $( "#list" ).listview( "refresh" ).find( ".ui-li.border" ).removeClass(
// "border" );
// })
// // During the transition the previous list item should get bottom border
// .prev( "li.ui-li" ).addClass( "border" );
// }
// // If it's not a touch device or the CSS transition isn't supported just
